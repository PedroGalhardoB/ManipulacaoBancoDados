...
author: "Amanda Cedro, Elisa Amorim, Luiz Fernando e Pedro Galhardo"
format: 
  revealjs:
    theme: moon
    slide-number: true
...
-   O banco "Google Play Store Apps" foi retirado da plataforma keagle e o link pode ser acessado nos slides anteriores
...
Sys.setenv(JULIA_HOME = "D:/Users/Pedro/AppData/Local/Programs/Julia-1.12.1/bin")
julia_setup()
```
...
Apesar de não ter o tempo mais rápido, R consolidou-se como uma ferramenta superior para a plotagem de gráficos. Sua sintaxe intuitiva e funções enxutas  facilitam mudanças estéticas.
Conclui-se que Python seria um meio termo entre R e Julia. O tempo é otimizado, a plotagem de gráfico não é tão simples quanto R, mas é mais funcional que Julia, ainda assim, a leitura para importação de banco de dados foi o momento onde houve maior latência.
